...
import online.alldare.auth.messaging.AccountLoginEventListener;
...
public class RedisStreamConfig {
    ...
    private final AccountLoginEventListener accountLoginEventListener;
    ...
    public StreamMessageListenerContainer<String, ObjectRecord<String, String>> streamMessageListenerContainer(
        ...
        String streamKey = "stream:logins";
        String groupName = "alldare-auth-login-group";
        String consumerName = "auth-login-worker-1";
